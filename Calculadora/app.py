...
#Numeric Buttons
Button(Window, text="1").grid(row=2, column=0, sticky=W+E)
Button(Window, text="2").grid(row=2, column=1, sticky=W+E)
Button(Window, text="3").grid(row=2, column=2, sticky=W+E)

Button(Window, text="4").grid(row=3, column=0, sticky=W+E)
Button(Window, text="5").grid(row=3, column=1, sticky=W+E)
Button(Window, text="6").grid(row=3, column=2, sticky=W+E)

Button(Window, text="7").grid(row=4, column=0, sticky=W+E)
Button(Window, text="8").grid(row=4, column=1, sticky=W+E)
Button(Window, text="9").grid(row=4, column=2, sticky=W+E)

#Buttons Operations
Button(Window, text="AC").grid(row=5, column=0, sticky=W+E)
Button(Window, text="0").grid(row=5, column=1, sticky=W+E)
